...
$sqlArea1 = mysqli_query($konek, "SELECT WeldID FROM area3 ORDER BY ID ASC LIMIT 1, 1");
...
if (empty($dataArea1["WeldID"])) {
    ...
    $sqlMachineHistory = mysqli_query($konek, "SELECT * FROM machinehistory3 WHERE WeldID = '$WeldID' ORDER BY ID DESC LIMIT 1");
