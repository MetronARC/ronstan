...
// Fetch WeldID from the "area1" table (fetching from the 1st row)
$sqlWeldID = "SELECT WeldID FROM area3 WHERE Status='Active' LIMIT 1";
...
$sqlArcOn = "SELECT ArcOn FROM machinehistory3 WHERE WeldID = '$weldID' ORDER BY id DESC LIMIT 1";
