...
$sql_sensor1 = mysqli_query($konek, "SELECT * FROM area5 WHERE Status='Active' ORDER BY ID ASC LIMIT 1 OFFSET 2");
...
$sql_sensor2 = mysqli_query($konek, "SELECT * FROM area5 WHERE Status='Active' ORDER BY ID ASC LIMIT 1 OFFSET 2");
...
$sql_sensor3 = mysqli_query($konek, "SELECT WeldID FROM area5 WHERE Status='Active' LIMIT 1 OFFSET 2");
...
if (empty($weldID)) {
    ...
    $sql_machinehistory = mysqli_query($konek, "SELECT * FROM machinehistory5 WHERE WeldID = '$weldID'");
    $sumArcTotal = 0;
