...
$sqlArea1 = mysqli_query($konek, "SELECT WeldID FROM areaTest ORDER BY ID ASC LIMIT 1");
...
if (empty($dataArea1["WeldID"])) {
    ...
    $sqlMachineHistory = mysqli_query($konek, "SELECT * FROM machinehistoryTest WHERE WeldID = '$WeldID' ORDER BY ID DESC LIMIT 1");
