            ...
            for ($i = 1; $i <= $totalDivs; $i++) {
                echo '
                    setInterval(function(){
                        $.get(\'AreaMonitoring2/Machine' . $i . '/cekMachineState.php\', function(data) {
                            if (data.trim() === \'Active\') {
    ...
    <script>
        $(document).ready(function () {
            ...
            for ($i = 1; $i <= $totalDivs; $i++) {
                echo '
                    setInterval(function(){
                        $("#cekMachine' . $i . 'ID").load(\'AreaMonitoring2/Machine' . $i . '/cekMachineID.php\');
                    }, 1000);
                ';
            }
            ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            for ($i = 1; $i <= $totalDivs; $i++) {
                echo '
                    setInterval(function(){
                        $("#cekMachine' . $i . 'Arc").load(\'AreaMonitoring2/Machine' . $i . '/cekMachineArc.php\');
                    }, 1000);
                ';
            }
            ?>
    ...
    <div class="container" data-aos="zoom-out">
        ...
        <main>
            ...
            <div class="date" style="background-color: white; border: 1px solid #ccc; border-radius: 10px; padding: 10px; color: #37b4fe;">
                <a href="recaparea2.php"><h1 style="color: #37b4fe">Area Recap</h1></a>
            </div>
                    ...
                    echo '
                        <div class="sales">
                            ...
                            <div class="middle">
                                ...
                                <div class="progress">
                                    <a href="AreaMonitoring2/Machine' . $i . '/Machine.php"><img id="img' . $i . '" src="images/machineInactive.png"></a>
                                </div>
                            </div>
                        </div>';
                }
