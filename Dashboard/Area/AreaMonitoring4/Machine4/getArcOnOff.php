...
$sqlWeldID = "SELECT WeldID FROM area4 WHERE Status='Active' LIMIT 3, 1";
...
if ($resultWeldID->num_rows > 0) {
    ...
    $stmt = $konek->prepare("SELECT ArcOn, ArcOff, ArcTotal, CurrentDC FROM machinehistory4 WHERE WeldID = ?");
