...
$sql_sensor1 = mysqli_query($konek, "SELECT * FROM area4 WHERE Status='Active' ORDER BY ID ASC LIMIT 1 OFFSET 4");
...
$sql_sensor2 = mysqli_query($konek, "SELECT * FROM area4 WHERE Status='Active' ORDER BY ID ASC LIMIT 1 OFFSET 4");
...
$sql_sensor3 = mysqli_query($konek, "SELECT WeldID FROM area4 WHERE Status='Active' LIMIT 1 OFFSET 4");
