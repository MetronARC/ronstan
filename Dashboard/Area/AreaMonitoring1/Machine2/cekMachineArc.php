...
$sqlWeldID = "SELECT WeldID FROM area1 WHERE Status='Active' LIMIT 1 OFFSET 1";
...
$sqlArcOn = "SELECT ArcOn FROM machinehistory1 WHERE WeldID = '$weldID' ORDER BY id DESC LIMIT 1";
