...
$sql_sensor1 = mysqli_query($konek, "SELECT * FROM area1 WHERE Status='Active' ORDER BY ID ASC LIMIT 1 OFFSET 1");
...
$sql_sensor2 = mysqli_query($konek, "SELECT * FROM area1 WHERE Status='Active' ORDER BY ID ASC LIMIT 1 OFFSET 1");
...
$sql_sensor3 = mysqli_query($konek, "SELECT WeldID FROM area1 WHERE Status='Active' LIMIT 1 OFFSET 1");
$data_sensor3 = mysqli_fetch_array($sql_sensor3);
$weldID = $data_sensor3["WeldID"];

$sql_sensor4 = mysqli_query($konek, "SELECT * FROM area1 WHERE Status='Active' ORDER BY ID ASC LIMIT 1 OFFSET 1");
...
$sql_sensor5 = mysqli_query($konek, "SELECT * FROM area1 WHERE Status='Active' ORDER BY ID ASC LIMIT 1 OFFSET 1");
