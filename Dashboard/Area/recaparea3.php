...
$sql = "SELECT * FROM recaparea3 WHERE Date BETWEEN '$startDate' AND '$endDate'"; // Replace 'your_table_name' with the actual table name
...
// Modify the SQL query to use the specified date range
$sql = "SELECT * FROM machinehistory3 WHERE Date BETWEEN '$startDate2' AND '$endDate2'"; // Replace 'your_table_name' with the actual table name
...
<body>
    ...
    <div style="display: flex; align-items: center; justify-content: center; gap: 1rem;">
        <h2>Area 3 Machine Usage History</h2>
...
?>
    ...
    <div style="display: flex; align-items: center; justify-content: center; gap: 1rem">
        <h2>Area 3 Machine Arc On/Off History</h2>
    ...
    var fileName = 'Area 3_Machine_Usage_History_' + getCurrentDateTime() + '.xlsx';
...
<script>
    ...
    function exportToExcel(tableId) {
        ...
        var wb = XLSX.utils.book_new();
        XLSX.utils.book_append_sheet(wb, ws, 'Sheet1');
        var fileName = 'Area 3_ArcOn_ArcOff_History_' + getCurrentDateTime() + '.xlsx';
    ...
    <script>
        function fetchDataByDate() {
            ...
            window.location.href = 'recaparea3.php?startDate=' + startDate + '&endDate=' + endDate;
        }
...
<script>
    function fetchArcHistoryByDate() {
        ...
        window.location.href = 'recaparea3.php?startDate2=' + arcHistoryStartDate + '&endDate2=' + arcHistoryEndDate;
    }
</script>
