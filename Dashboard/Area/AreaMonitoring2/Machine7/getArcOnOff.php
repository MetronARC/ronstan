...
$sqlWeldID = "SELECT WeldID FROM area2 WHERE Status='Active' LIMIT 6, 1";
...
if ($resultWeldID->num_rows > 0) {
    ...
    $stmt = $konek->prepare("SELECT ArcOn, ArcOff, ArcTotal, CurrentDC FROM machinehistory2 WHERE WeldID = ?");
