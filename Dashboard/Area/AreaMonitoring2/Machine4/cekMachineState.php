...
$sqlArea1 = mysqli_query($konek, "SELECT WeldID FROM area2 ORDER BY ID ASC LIMIT 3, 1");
...
if (empty($dataArea1["WeldID"])) {
    ...
    $sqlMachineHistory = mysqli_query($konek, "SELECT * FROM machinehistory2 WHERE WeldID = '$WeldID' ORDER BY ID DESC LIMIT 1");
