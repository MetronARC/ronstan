            ...
            for ($i = 1; $i <= $totalDivs; $i++) {
                echo '
                    setInterval(function(){
                        $.get(\'AreaMonitoring3/Machine' . $i . '/cekMachineState.php\', function(data) {
                            if (data.trim() === \'Active\') {
    ...
    <script>
        $(document).ready(function () {
            ...
            for ($i = 1; $i <= $totalDivs; $i++) {
                echo '
                    setInterval(function(){
                        $("#cekMachine' . $i . 'ID").load(\'AreaMonitoring3/Machine' . $i . '/cekMachineID.php\');
                    }, 1000);
                ';
            }
            ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            for ($i = 1; $i <= $totalDivs; $i++) {
                echo '
                    setInterval(function(){
                        $("#cekMachine' . $i . 'Arc").load(\'AreaMonitoring3/Machine' . $i . '/cekMachineArc.php\');
                    }, 1000);
                ';
            }
            ?>
                    ...
                    echo '
                        <div class="sales">
                            ...
                            <div class="middle">
                                ...
                                <div class="progress">
                                    <a href="AreaMonitoring3/Machine' . $i . '/Machine.php"><img id="img' . $i . '" src="images/machineInactive.png"></a>
                                </div>
                            </div>
                        </div>';
                }
